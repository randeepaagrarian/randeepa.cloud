...
Sale.actToday = function(date, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE DATE(S.date) = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', date, function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByDateRegion = function(year, month, date, region, callback) {
    ...
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE DATE(S.sys_date) = ? AND S.region = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [paramDate, region], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByDateOfficer = function(year, month, date, officer, callback) {
    ...
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE DATE(S.sys_date) = ? AND S.officer = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [paramDate, officer], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.actByMonthAll = function(year, month, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.date) = ? AND MONTH(S.date) = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, month], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByMonthAll = function(year, month, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? AND MONTH(S.sys_date) = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, month], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByMonthRegion = function(year, month, region, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? AND MONTH(S.sys_date) = ? AND S.region = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, month, region], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByMonthOfficer = function(year, month, officer, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? AND MONTH(S.sys_date) = ? AND S.officer = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, month, officer], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByYearAll = function(year, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', year, function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByYearRegion = function(year, region, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? AND S.region = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, region], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.sysByYearOfficer = function(year, officer, callback) {
    MySql.pool.getConnection(function(pool_err, connection) {
        ...
        connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, M.name as model_name, S.invoice_no, S.price, ST.name as sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE YEAR(S.sys_date) = ? AND S.officer = ? GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, S.customer_address, S.customer_contact, model_name, S.invoice_no, S.price, sale_type_name, S.institute, S.advance, S.latitude, S.longitude, S.verified, S.verified_by, verified_on ORDER BY S.id DESC', [year, officer], function(err, rows, fields) {
            connection.release()
            if(err) {
                return callback(err, null)
            }
...
Sale.searchByChassisNo = function(chassisNo, callback) {
  MySql.pool.getConnection(function(pool_err, connection) {
      ...
      connection.query('SELECT S.id, COUNT(SC.sale_id) as sale_comments, U.name as officer_name, R.name as region_name, T.name as territory_name, DATE_FORMAT(S.date, \'%Y-%m-%d\') as date, DATE_FORMAT(S.sys_date, \'%Y-%m-%d %H:%I:%S\') as sys_date, S.location, D.name as sd_location, S.location_fk, S.chassis_no, S.customer_name, M.name as model_name, S.verified, S.verified_by, DATE_FORMAT(S.verified_on, \'%Y-%m-%d %H:%I:%S\') as verified_on FROM sale S LEFT JOIN dealer D ON S.location_fk = D.id AND S.location_fk <> 0 LEFT JOIN user U ON S.officer = U.username  LEFT JOIN region R ON S.region = R.id LEFT JOIN territory T ON S.territory = T.id LEFT JOIN model M on S.model = M.id LEFT JOIN sale_type ST ON S.sale_type = ST.id LEFT JOIN sale_comment SC ON SC.sale_id = S.id WHERE S.chassis_no LIKE  \'%' + chassisNo + '%\' GROUP BY S.id, officer_name, region_name, territory_name, date, sys_date, S.location, sd_location, S.location_fk, S.chassis_no, S.customer_name, model_name, S.verified, S.verified_by, verified_on ORDER BY id DESC', function(err, rows, fields) {
          connection.release()
          if(err) {
              return callback(err, null)
          }
